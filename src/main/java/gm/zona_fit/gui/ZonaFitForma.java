...
public class ZonaFitForma extends JFrame{
    ...
    //Se hace la inyeccion de dependencia desde la creacion del constructor, ya que se requiera que en la tabla(gui) obtenga esa información y no desde un atributo(ya que seria muy tarde de la obtencion de la informacion.)
    @Autowired
    ...
    private void guardarCliente(){
        ...
        if (membresiaTexto.getText().equals("")){
            mostrarMensaje("Proporcione una membresia");
        ...
        this.clienteServicio.guardarCliente(cliente); //Inserta el cliente en la BD / modificar
